...
```{r,echo=FALSE, out.width="100%", fig.align='center', fig.alt="workflow example"}
knitr::include_graphics("https://github.com/animalbiodiversitylab/envar/blob/main/man/figures/Fig1.png")
```

![workflow example](man/figures/Fig1.png)
