# Contributing to envar

This outlines how to propose a change to envar. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Andreacerofolini/envar", fork = TRUE)`.
...
Please note that the envar project is released with a [Contributor Code
of
Conduct](https://animalbiodiversitylab.github.io/envar/CODE_OF_CONDUCT.md).
