...
The `rnaturalearthdata` package is also used (when selecting a study area
by country or continent) and is installed automatically with
`rnaturalearth`.
...
> biogeography. Ecological Informatics, 99, 104033.
> <https://doi.org/10.1016/j.ecoinf.2026.104033>
